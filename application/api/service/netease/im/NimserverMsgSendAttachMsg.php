...
class NimserverMsgSendAttachMsg extends Base
{
    ...
    public function request($params)
    {
        try {
            $response = $this->httpClient->post(
                $this->apiConf['nimserver.msg.sendAttachMsg'],
                [
                    'form_params' => $params,
            ...
            Monolog::error('发送自定义系统通知失败,[NimserverMsgSendAttachMsg]' . $e->getMessage(), [$params]);
        }
        return false;
    }
