...
class NimserverTeamRemoveManager extends Base
{
    ...
    public function request($params)
    {
        try {
            $response = $this->httpClient->post(
                $this->apiConf['nimserver.team.removeManager'],
                [
                    'form_params' => $params,
            ...
            Monolog::error('移除管理员失败,[NimserverTeamRemoveManager]' . $e->getMessage(), [$params]);
        }
        return false;
    }
